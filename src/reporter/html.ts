...
<div style="margin:2rem 0;padding:1.5rem 2rem;background:linear-gradient(135deg,#1e3a5f 0%,#1e293b 100%);border:1px solid #334155;border-radius:12px;display:flex;align-items:center;justify-content:space-between;gap:1.5rem;flex-wrap:wrap">
  <div style="display:flex;align-items:center;gap:1rem">
    <span style="font-size:2rem">🔍</span>
    <div>
      <p style="margin:0;font-size:1rem;font-weight:600;color:#f1f5f9">Vrei să testăm site-ul și din punct de vedere al SEO, performanță, securitate și accesibilitate?</p>
      <p style="margin:0.25rem 0 0;font-size:0.85rem;color:#94a3b8">Obține un audit complet AI — scoruri detaliate pe 9 categorii, recomandări prioritizate și fix automat.</p>
    </div>
  </div>
  <a href="https://techbiz.ae" target="_blank" rel="noopener noreferrer" style="display:inline-flex;align-items:center;gap:0.5rem;padding:0.6rem 1.4rem;background:#2563eb;color:#fff;text-decoration:none;border-radius:8px;font-size:0.9rem;font-weight:600;white-space:nowrap;flex-shrink:0">
    Audit gratuit →
  </a>
</div>

<footer>
  Generated by <strong>@aledan007/tester</strong> on ${new Date().toISOString()}
</footer>
